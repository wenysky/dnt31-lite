...
<div class="ManagerForm" style="margin:4px 30px 10px;">
	    ...
	    <table width="100%">
	     ...
	     <tr>
	         <td class="vtop" colspan="2">
	           <textarea name="invitationuserdescription" id="invitationuserdescription" runat="server" cols="80" rows="20"></textarea>
	         </td>
		 </tr>
		 <tr>
	     ...
	     <tr>
	         <td class="vtop" colspan="2">
	           <textarea name="invitationvisitordescription" id="invitationvisitordescription" runat="server" cols="80" rows="20"></textarea>
	         </td>
		 </tr>
		 <tr>
	     ...
	     <tr>
	         <td class="vtop" colspan="2">
	           <textarea name="invitationemailmodel" id="invitationemailmodel" runat="server" cols="80" rows="20"></textarea>
	         </td>
	     </tr>
	     <tr>
	...
	<script type="text/javascript">
		...
		dntEditor = new DNTeditor('invitationuserdescription', '70%', '220', document.getElementById('invitationuserdescription').value);
		dntEditor.BasePath = '<%=Discuz.Config.BaseConfigs.GetForumPath %>';
		dntEditor.RedundancyHeight = 40;
		dntEditor.ReplaceTextarea();
		dntEditor1 = new DNTeditor('invitationvisitordescription', '70%', '220', document.getElementById('invitationvisitordescription').value);
		dntEditor1.BasePath = '<%=Discuz.Config.BaseConfigs.GetForumPath %>';
		dntEditor1.RedundancyHeight = 40;
		dntEditor1.ReplaceTextarea();
		dntEditor2 = new DNTeditor('invitationemailmodel', '70%', '220', document.getElementById('invitationemailmodel').value);
		dntEditor2.BasePath = '<%=Discuz.Config.BaseConfigs.GetForumPath %>';
		dntEditor2.RedundancyHeight = 40;
		dntEditor2.ReplaceTextarea();

		}

		function PrepareSave() {
		document.getElementById('invitationuserdescription').value = dntEditor.GetHtml();
		document.getElementById('invitationvisitordescription').value = dntEditor1.GetHtml();
		document.getElementById('invitationemailmodel').value = dntEditor2.GetHtml();
		}
