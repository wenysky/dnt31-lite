...
namespace Discuz.Web.Admin
{
    ...
    public partial class registerandvisit : AdminPage
    {
        ...
        public void LoadConfigInfo()
        {
            ...
            invitationuserdescription.InnerHtml = invitationConfigInfo.InvitationLoginUserDescription;//配置项赋值给textarea的innnerhtml能保证显示出来的是所见即所得的效果
            invitationvisitordescription.InnerHtml = invitationConfigInfo.InvitationVisitorDescription;
            invitationemailmodel.InnerHtml = invitationConfigInfo.InvitationEmailTemplate;
        ...
        private void SaveInfo_Click(object sender, EventArgs e)
        {
            ...
            if (this.CheckCookie())
            {
                ...
                invitationConfigInfo.InvitationLoginUserDescription = invitationuserdescription.Value;//保存的时候取textarea的value值可以保证前台显示正常
                invitationConfigInfo.InvitationVisitorDescription = invitationvisitordescription.Value;
                invitationConfigInfo.InvitationEmailTemplate = RepairEmailTemplateCodeParameter(invitationemailmodel.Value);
