...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("\" id=\"NavHome\" onmouseover=\"showMenu(this.id);\" onmouseout=\"showMenu(this.id);\">");
	templateBuilder.Append(config.Albumname.ToString().Trim());
	templateBuilder.Append("首页</a>  &raquo;  全部");
	templateBuilder.Append(config.Albumname.ToString().Trim());
	templateBuilder.Append("\r\n");
	...
	templateBuilder.Append("</h2>\r\n");
	templateBuilder.Append("			</div>\r\n");
	templateBuilder.Append("			<div class=\"inforsort\">\r\n");
	...
	templateBuilder.Append("				<p style=\"text-align:center; line-height:35px;\"><a href=\"usercpspacemanagealbum.aspx?albumid=-1\" class=\"newbutton\">创建新相册</a></p>\r\n");
