...
namespace Discuz.Web
{
    ...
    public class showtopiclist : PageBase
    {
        ...
        private void SetCondition()
        {
            ...
            if (!Utils.StrIsNullOrEmpty(forums))
            {
        ...
        private string GetAllowviewForums(string forums)
        {
            ...
            foreach (string strfid in forums.Split(','))
            {
                ...
                if (forumInfo != null && Forums.AllowView(forumInfo.Viewperm, usergroupid) &&
                    (Utils.StrIsNullOrEmpty(forumInfo.Password) || Utils.MD5(forumInfo.Password.Trim()) == ForumUtils.GetCookie("forum" + strfid.Trim() + "password")))
                {
        ...
        public static string GetForumCheckBoxListCache(string forums)
        {
            ...
            List<ForumInfo> forumList = Forums.GetForumList();// GetForumListTable();
            int count = 1;
