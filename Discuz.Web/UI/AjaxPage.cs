...
namespace Discuz.Web.UI
{
    ...
    public class AjaxPage : Page
    {
        ...
        //    postinfo.Invisible = (forum.Modnewposts == 1 && useradminid != 1) ? 1 : 0;
        ...
        //    _postpramsinfo.CurrentUserid = userid;
        //    UserInfo userInfo = Users.GetUserInfo(_postpramsinfo.CurrentUserid);
        //    _postpramsinfo.Usercredits = userInfo == null ? 0 : userInfo.Credits;
        ...
        //                attachmentinfo.Aid);
        //        else
        //            content = "[{'haserror': true, 'errormsg' : '对不起,您的账户余额不足 " + extcredit + ", 请返回!'}]";
        //    }
        //    return content;
        //}
