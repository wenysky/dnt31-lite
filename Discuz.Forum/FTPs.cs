...
namespace Discuz.Forum
{
    ...
    public class FTPs
    {
        ...
        private static FTPConfigInfo m_forumavatar = null;
        #endregion
        ...
        public bool UpLoadFile(string path, string file, FTPUploadEnum ftpuploadname)
        {
            ...
            switch (ftpuploadname)
            {
                ...
                case FTPUploadEnum.ForumAvatar:
                    {
                        ftpupload = new FTP(m_forumavatar.Serveraddress, m_forumavatar.Serverport, m_forumavatar.Username, m_forumavatar.Password, m_forumavatar.Timeout);
                        path = m_forumavatar.Uploadpath + path;
                        delfile = (m_forumavatar.Reservelocalattach == 1) ? false : true;
                        break;
                    }
            }
