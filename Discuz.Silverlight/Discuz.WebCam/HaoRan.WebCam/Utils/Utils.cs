...
namespace HaoRan.WebCam
{
    public class Utils
    {
        ...
        public static ObservableCollection<BitmapImage> GetPreviewImage(string url, string userid)
        {
            ...
            BitmapImage largeImage = new BitmapImage(new Uri(url.Replace("/services/UploadAvatar.asmx", avatarFileName + "large.jpg?random=" + new Random().Next(1, 10000)), UriKind.RelativeOrAbsolute));
            bitmapImageList.Add(largeImage);

            BitmapImage mediumImage = new BitmapImage(new Uri(url.Replace("/services/UploadAvatar.asmx", avatarFileName + "medium.jpg?random=" + new Random().Next(1, 10000)), UriKind.RelativeOrAbsolute));
            bitmapImageList.Add(mediumImage);

            BitmapImage smallImage = new BitmapImage(new Uri(url.Replace("/services/UploadAvatar.asmx", avatarFileName + "small.jpg?random=" + new Random().Next(1, 10000)), UriKind.RelativeOrAbsolute));
