...
namespace Discuz.Data
{
    public class Users
    {
        ...
        {
            return uid > 0 ? LoadSingleUserInfo(DatabaseProvider.GetInstance().GetUserInfoToReader(uid)) : null;
        }
        ...
        {
            return uid > 0 ? LoadSingleShortUserInfo(DatabaseProvider.GetInstance().GetShortUserInfoToReader(uid)) : null;
        }
