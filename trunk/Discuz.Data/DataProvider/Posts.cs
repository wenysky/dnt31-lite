...
namespace Discuz.Data
{
    public class Posts
    {
        ...
        {
            return DatabaseProvider.GetInstance().CreatePost(postInfo, postTableId);
        }
        ...
        public static int UpdatePost(PostInfo postsInfo, string postTableId)
        {
            return DatabaseProvider.GetInstance().UpdatePost(postsInfo, postTableId);
        }
        ...
        {    
            return DatabaseProvider.GetInstance().UpdatePostRateTimes(postidlist, PostTables.GetPostTableId(tid));
        }
        ...
        public static List<ShowtopicPagePostInfo> GetPostList(PostpramsInfo postpramsInfo)
        {
            ...
            if (!postpramsInfo.Condition.Equals(""))
                reader = DatabaseProvider.GetInstance().GetPostListByCondition(postpramsInfo, PostTables.GetPostTableId(postpramsInfo.Tid));
            else
                reader = DatabaseProvider.GetInstance().GetPostList(postpramsInfo, PostTables.GetPostTableId(postpramsInfo.Tid));
        ...
        {
            return DatabaseProvider.GetInstance().UpdatePostAttachmentType(pid, PostTables.GetPostTableId(tid), attType);
        }
        ...
        /// <param name="fidList">版块Id列表</param>
        public static void PassPost(int postTableId, string validatePidList, string deletePidList, string ignorePidList, string fidList)
        {
            DatabaseProvider.GetInstance().PassPost(postTableId, validatePidList, deletePidList, ignorePidList, fidList);
        }
