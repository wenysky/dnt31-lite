...
namespace Discuz.Data
{
    public class Searches
    {
        ...
        public static int Search(bool spaceenabled, bool albumenable,int posttableid, int userid, int usergroupid, string keyword, int posterid, string type, string searchforumid, int keywordtype, int searchtime, int searchtimetype, int resultorder, int resultordertype)
        {
            return DatabaseProvider.GetInstance().Search(spaceenabled, albumenable, posttableid, userid, usergroupid, keyword, posterid, type, searchforumid, keywordtype, searchtime, searchtimetype, resultorder, resultordertype);
        }
