...
namespace Discuz.Forum
{
    public class Sync
    {
        ...
        public static void UserRegister(int uId, string userName, string password)
        {
            List<DiscuzParam> paramList = new List<DiscuzParam>();
            paramList.Add(DiscuzParam.Create("uid", uId));
            paramList.Add(DiscuzParam.Create("user_name", userName));
            paramList.Add(DiscuzParam.Create("password", password));
            SendRequest(ASYNC_REGISTER, paramList.ToArray());
        }
        ...
        /// <returns></returns>
        public static void DeleteUsers(string uIds)
        {
            List<DiscuzParam> paramList = new List<DiscuzParam>();
            paramList.Add(DiscuzParam.Create("uids", uIds));

            SendRequest(ASYNC_DELETE_USER, paramList.ToArray());
        }
        ...
        /// <returns></returns>
        public static void RenameUser(int uId, string oldUserName, string newUserName)
        {
            List<DiscuzParam> paramList = new List<DiscuzParam>();
            paramList.Add(DiscuzParam.Create("uid", uId));
            paramList.Add(DiscuzParam.Create("old_user_name", oldUserName));
            paramList.Add(DiscuzParam.Create("new_user_name", newUserName));
            SendRequest(ASYNC_RENAME_USER, paramList.ToArray());
        }
        ...
        public static void UpdatePassword(string userName, string password)
        {
            ...
            paramList.Add(DiscuzParam.Create("user_name", userName));
            paramList.Add(DiscuzParam.Create("password", password));
            SendRequest(ASYNC_UPDATE_PASSWORD, paramList.ToArray());
        }
        ...
        /// <returns></returns>
        public static void UpdateCredits(int uId, int creditIndex, string amount)
        {
            List<DiscuzParam> paramList = new List<DiscuzParam>();
            paramList.Add(DiscuzParam.Create("uid", uId));
            paramList.Add(DiscuzParam.Create("credit_index", creditIndex.ToString()));
            paramList.Add(DiscuzParam.Create("amount", amount));
            SendRequest(ASYNC_UPDATE_CREDITS, paramList.ToArray());
        }
        ...
        /// <returns></returns>
        public static void UpdateSignature(int uId, string userName, string signature)
        {
            List<DiscuzParam> paramList = new List<DiscuzParam>();
            paramList.Add(DiscuzParam.Create("uid", uId));
            paramList.Add(DiscuzParam.Create("user_name", userName));
            paramList.Add(DiscuzParam.Create("signature", signature));
            SendRequest(ASYNC_UPDATE_SIGNATURE, paramList.ToArray());
        }
        ...
        /// <param name="signature"></param>
        /// <returns></returns>
        public static void UpdateProfile(int uId, string userName)
        {
            List<DiscuzParam> paramList = new List<DiscuzParam>();
            paramList.Add(DiscuzParam.Create("uid", uId));
            paramList.Add(DiscuzParam.Create("user_name", userName));
            SendRequest(ASYNC_UPDATE_PROFILE, paramList.ToArray());
        }
        ...
        public static void NewTopic(string topicId, string title, string author, string authorId, string fid)
        {
            List<DiscuzParam> paramList = new List<DiscuzParam>();
            ...
            SendRequest(ASYNC_NEW_TOPIC, paramList.ToArray());
        }

        public static void Reply(string postId, string topicId, string topicTitle, string poster, string posterId, string fid)
        {
            List<DiscuzParam> paramList = new List<DiscuzParam>();
            ...
            paramList.Add(DiscuzParam.Create("fid", fid));
            SendRequest(ASYNC_REPLY, paramList.ToArray());
        }
        /// <summary>
        /// 判断是否需要同步登录
        /// </summary>
