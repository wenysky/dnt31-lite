...
namespace Discuz.Web
{
    ...
    public class postreply : PageBase
    {
        ...
        //public DataTable GetLastPostDataTable()
        //{
        //    int hide = 0;
        //    if (topic.Hide == 1)
        //        hide = Posts.IsReplier(topicid, userid) ? -1 : topic.Hide;

        //    //判断是否为回复可见帖, price=0为非购买可见(正常), price > 0 为购买可见, price=-1为购买可见但当前用户已购买
        //    int price = topic.Price > 0 ? topic.Price : 0;
        ...
        //    return Posts.GetLastPostDataTable(postpramsinfo);
        //}
