...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2009-11-4 15:09:11.
		本页面代码由Discuz!NT模板引擎生成于 2009-11-4 15:09:11. 
	*/
	...
	templateBuilder.Append(config.InvitationLoginUserDescription.ToString().Trim());
	templateBuilder.Append("</td>\r\n");
	...
	templateBuilder.Append("					<td><input id=\"invitecode\" type=\"text\" value=\"");
	templateBuilder.Append(inviteurl.ToString());
	templateBuilder.Append("\" style=\"width:300px;margin-right:10px;\" readonly=\"readonly\" ondblclick=\"copycode($('invitecode'))\" /><span>双击文本框复制推广链接</span></td>\r\n");
	templateBuilder.Append("				</tr>\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("					<th><label for=\"successcount\">成功邀请用户</label></th>\r\n");
	templateBuilder.Append("					<td>");
	templateBuilder.Append(inviteCode.SuccessCount.ToString().Trim());
	templateBuilder.Append("人</td>\r\n");
	templateBuilder.Append("				</tr>\r\n");
	templateBuilder.Append("				<tr>\r\n");
	templateBuilder.Append("					<th><label for=\"convertcode\">可兑换到的积分</label></th>\r\n");
	templateBuilder.Append("					<td>");
	templateBuilder.Append(userscore.ToString());
	templateBuilder.Append("<button name=\"convertcode\" type=\"submit\" id=\"convertcode\" style=\"margin-left:10px;\">我要兑换</button></td>\r\n");
	templateBuilder.Append("				</tr>\r\n");
	templateBuilder.Append("				</table>\r\n");
	templateBuilder.Append("				</form>\r\n");
	templateBuilder.Append("				<hr class=\"solidline\"/>\r\n");
	templateBuilder.Append("				<form id=\"emailtoinvitefriend\" method=\"post\" action=\"invite.aspx?action=emailtoinvite\">\r\n");
	templateBuilder.Append("					<table summary=\"邀请注册\" cellspacing=\"0\" cellpadding=\"0\" class=\"formtable\"  id=\"invitecodemsg\">\r\n");
	templateBuilder.Append("					<tr id=\"promotiondescription\">\r\n");
	templateBuilder.Append("						<td><input id=\"email\" name=\"email\" type=\"text\" style=\"width:300px;margin-right:10px;\" class=\"txt\"/><button name=\"emailtoinvite\" type=\"submit\" id=\"emailtoinvite\">通过Email将邀请链接发送给好友</button></td>\r\n");
	templateBuilder.Append("					</tr>\r\n");
	templateBuilder.Append("					</table>\r\n");
	templateBuilder.Append("				</form>\r\n");
	...
	templateBuilder.Append("		   <div id=\"userinvitecodelist\" class=\"datalist\">\r\n");
	...
	templateBuilder.Append("				</div>\r\n");
	templateBuilder.Append("		   </div>\r\n");
	templateBuilder.Append("		   <form id=\"buyinvitecode\" method=\"post\" action=\"invite.aspx?action=buycode\">\r\n");
	templateBuilder.Append("			  <div id=\"buycode\">\r\n");
	templateBuilder.Append("				  当前邀请码售价: ");
	templateBuilder.Append(invitecodeprice.ToString());
	templateBuilder.Append("\r\n");

	if (invitecodecount<config.InviteCodeMaxCountToBuy)
	{

	templateBuilder.Append("<input id=\"buycode\" type=\"submit\" value=\"我要购买\" />\r\n");
	...
	templateBuilder.Append(config.InvitationVisitorDescription.ToString().Trim());
	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	templateBuilder.Append("		<td colspan=\"2\"><hr class=\"solidline\"/></td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	templateBuilder.Append("		    <td width=\"150\">\r\n");
	string avatarurl = Avatars.GetAvatarUrl(inviteCode.CreatorId);
	...
	templateBuilder.Append("templates/");
	templateBuilder.Append(templatepath.ToString());
	templateBuilder.Append("/images/noavatar_medium.gif';\"  alt=\"头像\" id=\"memberinfo\"/></td>\r\n");
	templateBuilder.Append("			<td id=\"creatormessage\" style=\"vertical-align:top\">\r\n");

	if (inviteCode!=null)
	{

	templateBuilder.Append("您好:<br/>您的朋友 ");
	templateBuilder.Append(inviteCode.Creator.ToString().Trim());
	templateBuilder.Append(" 邀请您加入到我们的行列当中<br />\r\n");

	}	//end if

	templateBuilder.Append("			请点击 <a href=\"register.aspx\r\n");

	if (inviteCode!=null)
	{

	templateBuilder.Append("?invitecode=");
	templateBuilder.Append(invitecode.ToString());
	templateBuilder.Append("\r\n");

	}	//end if

	templateBuilder.Append("\">加入！</a></td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		</table>\r\n");
