...
<Columns>
	...
	<asp:TemplateColumn HeaderText="头像">
		<ItemTemplate>
			<img src="<%# GetAvatarUrl(DataBinder.Eval(Container, "DataItem.uid").ToString())%>" onerror="this.onerror=null;this.src='../../templates/default/images/noavatar_small.gif';" width="48px" />
		</ItemTemplate>
	</asp:TemplateColumn>
