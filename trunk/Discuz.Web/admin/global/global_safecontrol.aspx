...
<table width="100%">
	...
	<tr>
		<td class="vtop rowform">
			<cc1:DropDownList ID="VerifyImage" runat="server"></cc1:DropDownList>
		</td>
		<td class="vtop"></td>
	</tr>
	...
	<tr>
		<td class="vtop rowform">
			<cc1:TextBox ID="seccodestatus" runat="server" HintShowType="down" CssClass="" RequiredFieldType="暂无校验" TextMode="MultiLine" Height="90px" Rows="4" Cols="30">
			</cc1:TextBox>
		</td>
		<td class="vtop">
		...
		<tr>
			<td>
				...
				<label for="seccodestatus_select_12">首页快速发帖</label>
			</td>
			<td>
			</td>
			<td>
		...
		请选取相应的页面复选框, 并在相应页面模板表单中加入{_vcode}校验码子模板, 就可以增加校验码判断功能.
		</td>
	</tr>
	...
	<tr>
		<td class="vtop rowform">
			 <cc1:TextBox SetFocusButtonID="SaveInfo" ID="postinterval" runat="server" RequiredFieldType="数据校验" CanBeNull="必填" Text="15" MaxLength="5" Size="6"></cc1:TextBox>(单位:秒)
		</td>
	...
	<tr>
		<td class="vtop rowform">
			<cc1:TextBox SetFocusButtonID="SaveInfo" ID="maxspm" runat="server" RequiredFieldType="数据校验" CanBeNull="必填" Text="0" MaxLength="3" Size="4"></cc1:TextBox>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			<cc1:TextBox SetFocusButtonID="SaveInfo" id="antispamusername" runat="server" Text="0" MaxLength="10" Size="10"></cc1:TextBox>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			<cc1:TextBox SetFocusButtonID="SaveInfo" id="antispamemail" runat="server" Text="0" MaxLength="10" Size="10"></cc1:TextBox>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			<cc1:TextBox SetFocusButtonID="SaveInfo" id="antispamtitle" runat="server" Text="0" MaxLength="10" Size="10"></cc1:TextBox>
		</td>
	...
	<tr>
		<td class="vtop rowform">
			<cc1:TextBox SetFocusButtonID="SaveInfo" id="antispammessage" runat="server" Text="0" MaxLength="10" Size="10"></cc1:TextBox>
		</td>
