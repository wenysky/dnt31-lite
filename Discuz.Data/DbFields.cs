...
namespace Discuz.Data
{
    public class DbFields
    {
        ...
        public const string TEMPLATES = "[templateid],[directory],[name],[author],[createdate],[ver],[fordntver],[copyright]";
