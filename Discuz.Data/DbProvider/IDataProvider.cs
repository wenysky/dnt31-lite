...
namespace Discuz.Data
{
    public interface IDataProvider
    {
        ...
        DataTable GetPostRateLogs(int pid, int displayRateCount);
        /// <summary>
        /// 获取帖子列表
        /// </summary>
        /// <param name="tid">主题ID</param>
        ...
        void PassPost(int tableId, string validate, string delete, string ignore, string fidList);
        /// <summary>
        /// 按条件获取评分日志列表
        /// </summary>
        /// <param name="pageSize">每页记录数</param>
        ...
        int Search(bool spaceEnabled, bool albumEnable, int postTableId, int userId, int userGroupId, string keyWord, int posterId, string type, string searchForumId, int keyWordType, int searchTime, int searchTimeType, int resultOrder, int resultOrderType);
        /// <summary>
        /// 生成搜索附件的条件
        /// </summary>
